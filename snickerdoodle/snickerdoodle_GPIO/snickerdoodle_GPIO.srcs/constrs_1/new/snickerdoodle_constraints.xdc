...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[24]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[15]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[13]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[14]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[20]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[17]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[21]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[16]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[18]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[19]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[5]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[23]}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[7}]
...
set_property PULLUP         TRUE        [get_ports {gpio0_tri_io[22]}]
...
set_property PULLUP         TRUE        [get_ports {gpio2_tri_io[20]}]
...
set_property PULLUP         TRUE        [get_ports {gpio2_tri_io[19]}]
...
set_property PULLUP         TRUE        [get_ports {gpio2_tri_io[2]}]
...
set_property PULLUP         TRUE        [get_ports {gpio2_tri_io[6]}]
...
set_property PULLUP         TRUE        [get_ports {gpio2_tri_io[23]}]
...
set_property PULLUP         TRUE        [get_ports {gpio2_tri_io[7]}]
