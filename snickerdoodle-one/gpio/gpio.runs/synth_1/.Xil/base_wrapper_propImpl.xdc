set_property SRC_FILE_INFO {cfile:Z:/Software/snickerdoodle-examples/snickerdoodle-one/gpio/gpio.srcs/constrs_1/imports/new/top.xdc rfile:../../../gpio.srcs/constrs_1/imports/new/top.xdc id:1} [current_design]
