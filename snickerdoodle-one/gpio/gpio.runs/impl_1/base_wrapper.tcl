...
set rc [catch {
  ...
  add_files -quiet Z:/Projects/snickerdoodle/snickerdoodle-examples/snickerdoodle-one/gpio/gpio.runs/synth_1/base_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top base_wrapper -part xc7z010clg400-1
  set_param project.isImplRun false
