...
#
# Generated by export_simulation on Sat May 14 14:51:25 -0700 2016
#
################################################################################
...
switch to the './base_block_design.sh' script.

./base_block_design.sh -reset_run
...
./base_block_design.sh -noclean_files

For more information on the script, please type './base_block_design.sh -help'.
