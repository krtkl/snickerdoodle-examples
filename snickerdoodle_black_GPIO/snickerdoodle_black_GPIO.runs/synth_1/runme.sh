...
HD_PWD='C:/snickerdoodle_black_GPIO/snickerdoodle_black_GPIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_block_design_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source base_block_design_wrapper.tcl
