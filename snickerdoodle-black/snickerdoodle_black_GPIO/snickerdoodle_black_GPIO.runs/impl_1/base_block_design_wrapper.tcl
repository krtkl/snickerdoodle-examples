...
set rc [catch {
  ...
  set_property webtalk.parent_dir Z:/Software/snickerdoodle-examples/snickerdoodle_black_GPIO/snickerdoodle_black_GPIO.cache/wt [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  catch { write_mem_info -force base_block_design_wrapper.mmi }
  write_bitstream -force -no_partial_bitfile base_block_design_wrapper.bit 
