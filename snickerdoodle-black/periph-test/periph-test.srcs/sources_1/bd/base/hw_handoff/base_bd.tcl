...
proc create_root_design { parentCell } {
  ...
  set AXI_GPIO [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 AXI_GPIO ]
  set AXI_IIC [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 AXI_IIC ]
  set AXI_SPI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 AXI_SPI ]
  set DDR [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddrx_rtl:1.0 DDR ]
  set EMIO_GPIO [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 EMIO_GPIO ]
  set EMIO_IIC [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 EMIO_IIC ]
  set EMIO_UART [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 EMIO_UART ]
  set FIXED_IO [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_processing_system7:fixedio_rtl:1.0 FIXED_IO ]

  # Create ports
  set AXI_UART_rxd [ create_bd_port -dir I AXI_UART_rxd ]
  set AXI_UART_txd [ create_bd_port -dir O AXI_UART_txd ]
  set EMIO_SPI_io0_o [ create_bd_port -dir O EMIO_SPI_io0_o ]
  set EMIO_SPI_io1_i [ create_bd_port -dir I EMIO_SPI_io1_i ]
  set EMIO_SPI_sck_o [ create_bd_port -dir O EMIO_SPI_sck_o ]
  set EMIO_SPI_ss_o [ create_bd_port -dir O EMIO_SPI_ss_o ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports AXI_GPIO] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports AXI_IIC] [get_bd_intf_pins axi_iic_0/IIC]
  connect_bd_intf_net -intf_net axi_quad_spi_0_SPI_0 [get_bd_intf_ports AXI_SPI] [get_bd_intf_pins axi_quad_spi_0/SPI_0]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports EMIO_IIC] [get_bd_intf_pins processing_system7_0/IIC_0]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_UART_1 [get_bd_intf_ports EMIO_UART] [get_bd_intf_pins processing_system7_0/UART_1]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins axi_uart16550_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net EMIO_SPI_io1_i_1 [get_bd_ports EMIO_SPI_io1_i] [get_bd_pins processing_system7_0/SPI0_MISO_I]
  ...
  connect_bd_net -net axi_uart16550_0_sout [get_bd_ports AXI_UART_txd] [get_bd_pins axi_uart16550_0/sout]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_99M/slowest_sync_clk]
  ...
  connect_bd_net -net processing_system7_0_SPI0_MOSI_O [get_bd_ports EMIO_SPI_io0_o] [get_bd_pins processing_system7_0/SPI0_MOSI_O]
  connect_bd_net -net processing_system7_0_SPI0_SCLK_O [get_bd_ports EMIO_SPI_sck_o] [get_bd_pins processing_system7_0/SPI0_SCLK_O]
  connect_bd_net -net processing_system7_0_SPI0_SS_O [get_bd_ports EMIO_SPI_ss_o] [get_bd_pins processing_system7_0/SPI0_SS_O]
  connect_bd_net -net rst_ps7_0_99M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_99M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_99M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_99M/peripheral_aresetn]
  connect_bd_net -net sin_0_1 [get_bd_ports AXI_UART_rxd] [get_bd_pins axi_uart16550_0/sin]
